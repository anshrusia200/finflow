    ...
    <>
      ...
      >
        <div align="center">
          <a href="/">
            <img
              src="https://github.com/anshrusia200/finflow/blob/master/client/public/static/logo.png?raw=true"
              alt="Logo"
              width="80"
              height="80"
            />
          ...
          <p align="center">
            ...
            <Copyright />
            <br />
            <a href="https://github.com/anshrusia200/finflow/issues">
              Report Bug
            </a>
            &nbsp;&nbsp;&nbsp;
            <a href="https://github.com/anshrusia200/finflow/issues">
        ...
        <center>
          <img
            src="https://raw.githubusercontent.com/tuzup/FinFlow/master/Screenshots/dashboard-main-transparent.png"
            alt="FinFlow"
            width={"80%"}
          />
        </center>
        ...
        <br />
        <p>
          FinFlow is a full stack expense spliting app - splitwise clone made
          using the MERN stack (MongoDB, Express, React &amp; Nodejs), specially
          designed to split group expense between friends, but can be used for
          almost any type of business need. With this application, you can add
          your expense details and get an whole expense analytics feature -
          Group Balance, Monthly amount spend, Catagory wise expense spending
          graph etc... Jump right off the{" "}
          <a href="https://split-app00.herokuapp.com/">Live App</a> and start
          adding your expenses or download the entire{" "}
          <a href="https://github.com/anshrusia200/finflow/">Source code</a> and
          run it on your server. This project is something I&#39;ve been working
          on in my free time so I cannot be sure that everything will work out
          correctly. But I&#39;ll appreciate you if can report any issue.
        </p>
        <br />
        <center>
          <img
            src="https://raw.githubusercontent.com/tuzup/FinFlow/master/Screenshots/combined-screenshot.png"
            alt="Features"
            width={"80%"}
          />
        </center>
