      ...
      <Routes>
        ...
        >
          ...
          <Route
            ...
            element={<EditGroup />}
          />
          <Route path={configData.USER_PROFILE_URL} element={<Profile />} />
        </Route>

        <Route path={configData.LOGIN_URL} element={<LogoOnlyLayout />}>
          <Route path={""} element={<Login />} />
          <Route path={configData.REGISTER_URL} element={<Register />} />
          <Route
            path={configData.USER_DELETED_URL}
            element={<PageUserDeleted />}
          />
          <Route path={configData.REGISTER_URL} element={<About />} />
        </Route>
      </Routes>
      {/* </div> */}
    </BrowserRouter>
